...
if (mysqli_num_rows($select) > 0) {
    ...
    mysqli_query($con,"INSERT INTO `logingform`(username ,email,password) VALUES('$name','$email','$pass') ") or die ('query failded');
            ...
            <div class="col2">
                ...
                <div class="fcontainer"  >
                    <div class="fbtn">
                        ...
                        <center><b>Registation form</b></center>
                    </div>
                    ...
                    <form action="" id="registerform" method="Post" >
                        ...
                        <input type="submit" class="btn" name="submit" value="registor Now">
                      
                        <p class="regp">Already have an acount?<a href="loging.php">Loging Now</p>
                    </form> 
