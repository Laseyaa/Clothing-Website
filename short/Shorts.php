...
$total_items_query = mysqli_query($con, "SELECT COUNT(*) AS total FROM `products` WHERE `category` = 'Shorts'") or die('Query failed');
$total_items_result = mysqli_fetch_assoc($total_items_query);
$total_items = $total_items_result['total'];
$total_pages = ceil($total_items / $items_per_page);


$select_product_query = "SELECT * FROM `products` WHERE `category` = 'Shorts' ORDER BY $order_by LIMIT $offset, $items_per_page";
                        ...
                        <ul class="menu-main">
                            ...
                            <li class="menu-item-has-children">
                                ...
                                <div class="submenu mega-menu mega-menu-column-4">
                                    ...
                                    <div class="list-item text-center">
                                        <a href="#">
                                        <img src="images/tt.jpg" alt=" "  width="400px" height="300px">
                                        <h4  class="title">Product 3</h4></a>
                                    </div>
                                    <div class="list-item text-center">
                                        <a href="#">
                                        <img src="images/ssd.jpg" alt=""  width="400px" height="300px">
