...
$total_items_query = mysqli_query($con, "SELECT COUNT(*) AS total FROM `products` WHERE `description` = 'All-Accessories'") or die('Query failed');
$total_items_result = mysqli_fetch_assoc($total_items_query);
$total_items = $total_items_result['total'];
$total_pages = ceil($total_items / $items_per_page); 


$select_product_query = "SELECT * FROM `products` WHERE `description` = 'All-Accessories' ORDER BY $order_by LIMIT $offset, $items_per_page";
